...
if TYPE_CHECKING:
    from pptx.opc.package import _Relationships  # pyright: ignore[reportPrivateUsage]
...
def import_slide(
    ...
    ----------
    src_slide_part:
        The :class:`~pptx.parts.slide.SlidePart` from the source presentation.
    dst_prs_part:
        The :class:`~pptx.parts.presentation.PresentationPart` of the target.
    merge_master:
    ...
    -------
    Slide
        The newly imported :class:`~pptx.slide.Slide` object.
    """
...
class _SlideImporter:
    ...
    def _find_or_clone_layout_in_master(
        ...
        from pptx.opc.constants import RELATIONSHIP_TYPE as RT2
