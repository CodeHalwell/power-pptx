...
if TYPE_CHECKING:
    ...
    from pptx.oxml.dml.three_d import CT_Bevel, CT_ContourColor, CT_ExtrusionColor, CT_Shape3D
...
class ThreeDFormat:
    ...
    Obtain an instance from :attr:`pptx.shapes.base.BaseShape.three_d`.
