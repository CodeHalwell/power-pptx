...
from power_pptx.oxml.ns import NamespacePrefixedTag
...
from power_pptx.oxml.action import CT_Hyperlink  # noqa: E402

register_element_cls("a:hlinkClick", CT_Hyperlink)
register_element_cls("a:hlinkHover", CT_Hyperlink)


from power_pptx.oxml.chart.axis import (  # noqa: E402
    CT_AxisUnit,
    CT_CatAx,
    CT_ChartLines,
    CT_Crosses,
...
from power_pptx.oxml.chart.chart import (  # noqa: E402
    CT_Chart,
    CT_ChartSpace,
    CT_ExternalData,
    CT_PlotArea,
...
from power_pptx.oxml.chart.datalabel import CT_DLbl, CT_DLblPos, CT_DLbls  # noqa: E402
...
from power_pptx.oxml.chart.legend import CT_Legend, CT_LegendPos  # noqa: E402

register_element_cls("c:legend", CT_Legend)
register_element_cls("c:legendPos", CT_LegendPos)


from power_pptx.oxml.chart.marker import CT_Marker, CT_MarkerSize, CT_MarkerStyle  # noqa: E402
...
from power_pptx.oxml.chart.plot import (  # noqa: E402
    CT_Area3DChart,
    CT_AreaChart,
    CT_BarChart,
    CT_BarDir,
...
from power_pptx.oxml.chart.series import (  # noqa: E402
    CT_AxDataSource,
    CT_DPt,
    CT_Lvl,
    CT_NumDataSource,
...
from power_pptx.oxml.coreprops import CT_CoreProperties  # noqa: E402

register_element_cls("cp:coreProperties", CT_CoreProperties)


from power_pptx.oxml.dml.color import (  # noqa: E402
    CT_Color,
    CT_HslColor,
    CT_Percentage,
...
from power_pptx.oxml.dml.fill import (  # noqa: E402
...
from power_pptx.oxml.dml.effect import (  # noqa: E402
    CT_BlurEffect,
    CT_EffectList,
    CT_GlowEffect,
...
from power_pptx.oxml.dml.three_d import (  # noqa: E402
    CT_Bevel,
    CT_ContourColor,
    CT_ExtrusionColor,
    CT_Scene3D,
...
from power_pptx.oxml.dml.line import CT_PresetLineDashProperties  # noqa: E402

register_element_cls("a:prstDash", CT_PresetLineDashProperties)


from power_pptx.oxml.presentation import (  # noqa: E402
    CT_Presentation,
    CT_SlideId,
    CT_SlideIdList,
...
from power_pptx.oxml.shapes.autoshape import (  # noqa: E402
    CT_AdjPoint2D,
    CT_CustomGeometry2D,
    CT_GeomGuide,
    CT_GeomGuideList,
...
from power_pptx.oxml.shapes.connector import (  # noqa: E402
    CT_Connection,
    CT_Connector,
...
from power_pptx.oxml.shapes.graphfrm import (  # noqa: E402
    CT_GraphicalObject,
...
from power_pptx.oxml.shapes.groupshape import (  # noqa: E402
    CT_GroupShape,
...
from power_pptx.oxml.shapes.picture import CT_Picture, CT_PictureNonVisual  # noqa: E402
...
from power_pptx.oxml.shapes.shared import (  # noqa: E402
...
from power_pptx.oxml.slide import (  # noqa: E402
    CT_Background,
...
from power_pptx.oxml.table import (  # noqa: E402
    CT_Table,
    CT_TableCell,
...
from power_pptx.oxml.text import (  # noqa: E402
    CT_RegularTextRun,
    CT_TextBody,
...
from power_pptx.oxml.theme import CT_OfficeStyleSheet  # noqa: E402
