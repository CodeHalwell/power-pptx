...
from power_pptx.enum.shapes import MSO_AUTO_SHAPE_TYPE, MSO_SHAPE_TYPE
...
class AutoShapeType:
    ...
    .. attribute:: autoshape_type_id
       ...
       value in `power_pptx.constants.MSO` like `MSO_SHAPE.ROUNDED_RECTANGLE`.
    ...
    def __init__(self, autoshape_type_id: MSO_AUTO_SHAPE_TYPE):
        """Initialize attributes from constant values in `power_pptx.spec`."""
