...
:class:`~power_pptx.dml.fill.FillFormat`, :class:`~power_pptx.dml.line.LineFormat`,
and :class:`~power_pptx.dml.effect.ShadowFormat` calls.
...
#: Anything :func:`power_pptx.design.tokens._coerce_color` can turn into an RGB
...
class ShapeStyle:
    ...
    def fill(self, value: Optional[ColorLike]) -> None:
        ...
        the same way as :class:`power_pptx.design.tokens.DesignTokens`).  Pass
