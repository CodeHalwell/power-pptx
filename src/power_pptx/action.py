...
if TYPE_CHECKING:
    ...
    from power_pptx.oxml.shapes.shared import CT_NonVisualDrawingProps
    from power_pptx.oxml.text import CT_TextCharacterProperties
    from power_pptx.parts.slide import SlidePart
    from power_pptx.shapes.base import BaseShape
    from power_pptx.slide import Slide, Slides
